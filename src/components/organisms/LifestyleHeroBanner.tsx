  ...
  return (
    ...
    >
      <div className="velvet-hero-banner__inner relative flex flex-col overflow-hidden lg:min-h-[240px] lg:flex-row lg:items-stretch">
        <div className="relative z-10 flex flex-1 flex-col justify-center px-5 py-6 sm:px-8 sm:py-8 lg:max-w-[56%] lg:px-10 lg:py-9">
          {eyebrow}
          <div className="mt-0">{title}</div>
          <p className="mt-3 max-w-md text-sm leading-relaxed text-[#6f6a63] sm:text-[15px] lg:text-base">
            {subtitle}
          </p>
          {footer ? <div className="mt-5 sm:mt-6">{footer}</div> : null}
        </div>

        <div className="velvet-hero-banner__media relative mx-auto h-56 w-full max-w-lg shrink-0 sm:h-64 lg:absolute lg:right-0 lg:bottom-0 lg:top-0 lg:mx-0 lg:h-full lg:max-w-none lg:w-[44%] xl:w-[42%]">
          <Image
            src={HERO_IMAGE}
            alt=""
            width={800}
