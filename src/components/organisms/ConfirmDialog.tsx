        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className={cn(
                "relative z-10 flex w-full max-w-md flex-col overflow-hidden border border-outline-variant/25 bg-bg-elevated shadow-[0_24px_64px_rgba(46,42,39,0.28)]",
                "max-h-[min(70dvh,520px)] rounded-t-[1.75rem]",
                "sm:max-h-none sm:rounded-[1.75rem] md:rounded-[2rem]",
              )}
            ...
            >
              ...
              <div className="px-5 pt-4 pb-4 sm:px-8 sm:pt-8">
